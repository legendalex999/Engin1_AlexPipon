...
{
    [SerializeField]
    private Transform m_objectToRotateY; //empty GameObject in main character
    [SerializeField]
    private Transform m_objectToRotateX; // main character
    [SerializeField]
    ...
    private void UpdateHorizontalMovements()
    {
        ...
        m_objectToRotateX.transform.Rotate(new Vector3(0, currentAngleX, 0), Space.World);
    }
    ...
    private void UpdateVerticalMovements()
    {
        ...
        m_objectToRotateY.transform.Rotate(new Vector3(currentAngleY, 0, 0), Space.Self);
    }

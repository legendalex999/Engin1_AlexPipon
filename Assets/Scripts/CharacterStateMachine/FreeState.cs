...
public class FreeState : CharacterState
{
    ...
    private bool m_CanEnterFreeState => (!m_stateMachine.m_InAir && !m_stateMachine.m_IsGettingUp) && !m_stateMachine.m_IsOnGround;
    ...
    public override void OnUpdate()
    {
        ...
        {
            m_stateMachine.m_IsHit = true;
        }

        if (Input.GetMouseButtonDown(0) && !GameManagerSM.GetInstance().m_isCinematicState)
        {
            m_stateMachine.m_IsAttacking = true;
        }
    ...
    private void FreeStateMovement()
    {
        ...
        m_stateMachine.UpdateAnimationValue(m_lastVectorDirection);
